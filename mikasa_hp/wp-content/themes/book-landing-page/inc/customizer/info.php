...
if ( ! function_exists( 'book_landing_page_customizer_theme_info' ) ) :
	...
	function book_landing_page_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'book-landing-page' ), esc_url( __( 'https://rarathemes.com/previews/?theme=book-landing-page&utm_source=book_landing_page&utm_medium=customizer&utm_campaign=theme_demo', 'book-landing-page' ) ), esc_html__( 'Click here.', 'book-landing-page' ) );

	    $theme_info .= '</p><p>';

	    /* translators: 1: string, 2: documentation url, 3: string */
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'book-landing-page' ), esc_url( 'https://docs.rarathemes.com/docs/book-landing-page/?utm_source=book_landing_page&utm_medium=customizer&utm_campaign=docs' ), esc_html__( 'Click here.', 'book-landing-page' ) );
	...
	$manager->add_section(
		new Book_Landing_Page_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => esc_url('https://rarathemes.com/wordpress-themes/book-landing-page-pro/?utm_source=book_landing_page&utm_medium=customizer&utm_campaign=upgrade_to_pro')
			)
		)
	);
}
