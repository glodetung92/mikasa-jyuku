 ...
 * @return array
 */
if( ! function_exists( 'book_landing_page_get_sidebar_layout_data' ) ){
    function book_landing_page_get_sidebar_layout_data(){
        return array(
            'right-sidebar' => array(
                'value'=> 'right-sidebar',
...
/**
 * Sidebar layout metabox callback
 */
function book_landing_page_sidebar_layout_callback(){
    global $post;
    $book_landing_page_sidebar_layout = book_landing_page_get_sidebar_layout_data();
